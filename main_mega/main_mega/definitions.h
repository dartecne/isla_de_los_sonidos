...
// PUENTE
//int puente_piezo_pin[] = { 0, 1, 2, 3, 4, 5 }; // analog inputs
int puente_piezo_pin[] = { 3, 4, 5, 2, 1, 0 }; // analog inputs
...
#else
int sonar_out_pin = 6;	// digital amarillo
int sonar_in_pin = 7;  // digital marron
#endif
long sonar_value = 0;
...
int ball_led_pin = 7;
#else
int ball_led_pin = 14;  // en realidad no hay pin para ese led
#endif
