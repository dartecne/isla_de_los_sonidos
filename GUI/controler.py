...
class Controler(threading.Thread, serial_interface):
    ...
    N_DATA = 40 # 46 # number of received parameteres
...
# TUNEL
        self.gui.m_textCtrl_tunel_sonar.SetValue(self.data[serial_interface.SONAR])
...
# TIMON
        ...
        self.gui.m_textCtrl_timon.SetValue(self.data[serial_interface.TIMON])

# SERES ISLA
        self.gui.m_checkBox_arpegiator.SetValue(bool(int(self.data[serial_interface.ARPEGIATOR])))
        ...
        self.gui.m_textCtrl_slide_1.SetValue(self.data[serial_interface.SLIDE_RIBBON[0]])
        self.gui.m_textCtrl_slide_2.SetValue(self.data[serial_interface.SLIDE_RIBBON[1]])

# CUEVA RUIDOS
        self.gui.m_radioBtn_cueva_1.SetValue(bool(int(self.data[serial_interface.CUEVA_SEL[0]])))
        self.gui.m_radioBtn_cueva_2.SetValue(bool(int(self.data[serial_interface.CUEVA_SEL[1]])))
        self.gui.m_radioBtn_cueva_3.SetValue(bool(int(self.data[serial_interface.CUEVA_SEL[2]])))

        self.gui.m_checkBox_seq_1.SetValue(bool(int(self.data[serial_interface.SW[0]])))
        self.gui.m_checkBox_seq_2.SetValue(bool(int(self.data[serial_interface.SW[1]])))
        self.gui.m_checkBox_seq_3.SetValue(bool(int(self.data[serial_interface.SW[2]])))
        self.gui.m_checkBox_seq_4.SetValue(bool(int(self.data[serial_interface.SW[3]])))
        self.gui.m_checkBox_seq_5.SetValue(bool(int(self.data[serial_interface.SW[4]])))
        self.gui.m_checkBox_seq_6.SetValue(bool(int(self.data[serial_interface.SW[5]])))

        self.gui.m_textCtrl_pot_1.SetValue(self.data[serial_interface.POT[0]])
        self.gui.m_textCtrl_pot_2.SetValue(self.data[serial_interface.POT[1]])
